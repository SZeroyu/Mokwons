...
<div>
  ...
  <p>
    <br><br><br><br>
    <h3>생활관 입사 신청서 다운로드</h3>
    <a href="img/입사신청서.hwp" download><button type="button">다운로드</button></a>
    <br />
</div>



<input type="button" value="인쇄" class="print_btn" onclick="location.href='dormitory.php'">

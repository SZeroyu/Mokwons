...
<div class="main_page01">
    <div class="page_info"><p>대학일반<span> &gt </span>학생<span> &gt </span><span class="page">학생 추가<span></p></div>
    <!-- 사이드 메뉴 -->
    <div class="side_menu">
        <div class="navigation">
            <ul>
                ...
                <li class="page_list"><p>학생</p></li>
                <li class="list active">
                    <a href="#" onclick="location.href='admin_학생추가.php'">
                            <span class="icon"><ion-icon name="person-add-outline"></ion-icon></span>
                            <span class="title">학생 추가</span>
                    </a>
                </li>
                <li class="list ">

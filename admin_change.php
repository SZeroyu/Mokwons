  ...
  <div class= "top_header"></div>
    <div>
      ...
      <table id="table_1" align=center  cellspacing="5">
            ...
            <th>학번/사번</th>
            <td name="user_number" class="inph_1"><?=$class_number?></td>
            <th>비밀번호</th>
            ...
            <tr> <td colspan="3"><input type="text" name="user_pnumber[<?php echo $i;?>]"   value = "<?=$user_pnumber?>"  placeholder="개인 전화번호" class="inph_3"></td></tr>
